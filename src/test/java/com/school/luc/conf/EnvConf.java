...
public class EnvConf {
  ...
  void configureProperties(DynamicPropertyRegistry registry) {
    ...
    registry.add(
        "spring.security.oauth2.client.provider.casdoor.authorization-uri", () -> "http://dummy");
    registry.add("spring.security.oauth2.client.provider.casdoor.token-uri", () -> "http://dummy");
    registry.add(
        "spring.security.oauth2.client.provider.casdoor.user-info-uri", () -> "http://dummy");
    registry.add(
        "spring.security.oauth2.client.provider.casdoor.jwk-set-uri", () -> "http://dummy");
