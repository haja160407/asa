...
import static com.school.luc.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.school.luc.PojaGenerated;
import com.school.luc.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "com.school.luc.event1";
    return "com.school.luc.event2";
  }
}
