package com.school.luc.endpoint.event.consumer;

import com.school.luc.PojaGenerated;
import com.school.luc.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.school.luc.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.school.luc.service.event."
